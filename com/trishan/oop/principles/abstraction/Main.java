...
public class Main {
    // Achieved via abstract classes and interfaces - process of gaining the information
    ...
    // Abstract Classes - determines nature of the methods the subclass must implement, just giving the definition of it, not the body.
    // - used for Abstraction and also used to achieve Multiple Inheritance with interfaces.
    // Abstract Methods - Empty methods without implementation, child class needs to override it in order to use it.
    // -> abstract void func(params);
    // Any class that contains one or more abstract methods, must be an abstract class.
