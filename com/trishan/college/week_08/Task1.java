...
public class Task1 {
//    You are building a banking application that has a BankAccount class. Implement the BankAccount class with
//    encapsulation principles in mind. Include private instance variables for the account number, account holder name,
//    and account balance. Provide public methods to allow clients to deposit and withdraw funds, as well as access
//    the account balance. Ensure that the account balance cannot be accessed or modified directly.
