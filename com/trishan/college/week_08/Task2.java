...
public class Task2 {
  // You are developing a library management system and need to implement a Book
  // class. The Book class should have
  // private instance variables for the book title, author name, and publication
  // year. Implement appropriate getter and
  // setter methods to ensure encapsulation. Additionally, include a private
  // variable to track the availability
  // of the book (e.g., true if available, false if borrowed), and provide a
