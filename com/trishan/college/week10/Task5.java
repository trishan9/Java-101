...
public class Task5 {
    //    You are building a shape hierarchy for a drawing application. Design an abstract class named "Draw" with the
//    following abstract methods:
//    calculateVolume(): This method should calculate and return the volume of the shape
...
//    Create subclasses for different shapes such as "Cube," "Cuboid," and "Cylinder." Each subclass should provide
//    specific implementations for calculating the volume, area and perimeter of that shape. Create instances of each
//    shape class and demonstrate how you can calculate their respective volume, areas and perimeters.
